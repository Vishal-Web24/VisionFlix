...
This is a fully functional, fullstack app built with the MERN stack — featuring AI-powered movie recommendations powered by Gemini AI, complete authentication, and a clean, responsive UI using real data from the TMDB API.

✅ This project is complete — from frontend to backend to AI integration and deployment. It’s built to showcase real-world skills.
