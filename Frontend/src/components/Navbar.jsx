...
import VisionFlix2 from "../assets/VisionFlix2.png";
  ...
  return (
    <nav className="bg-black text-gray-200 flex justify-between items-center p-4 h-20 text-sm md:text-[15px] font-medium text-nowrap">
      ...
      <Link to={"/"}>
        <img
          src={VisionFlix2}
          className=" w-55 h-50   cursor-pointer brightness-125"
          alt="logo"
        />
      </Link>
      <ul className="hidden xl:flex space-x-6">
        ...
        <li className="cursor-pointer hover:text-[#e50914]">Popular</li>
          ...
          <div className="text-white">
            ...
            {showMenu && (
              <div className="absolute right-0 mt-2 w-64 bg-[#232323] bg-opacity-95 rounded-lg z-50 shadow-lg py-4 px-3 flex flex-col gap-2 border border-[#333333]">
                ...
                <button className="flex items-center px-4 py-3 rounded-lg text-white bg-[#181818] hover:bg-[#2d2d2d] gap-3 cursor-pointer">
                ...
                <button
                  ...
                  className="flex items-center px-4 py-3 rounded-lg text-white bg-[#181818] hover:bg-[#2d2d2d] gap-3 cursor-pointer"
                >
